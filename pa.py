...
class WeiBo():
    ...
    def dddsx(self):
        dddsx_url = "https://weibo.com/u/3176010690"
        dddsx_url = "https://weibo.com/3176010690/JeGuVbOlD?filter=hot&root_comment_id=4534999682390530&type=comment#_rnd1597992639830"
        dddsx_url = "https://weibo.com/3176010690/JeGuVbOlD?filter=hot&root_comment_id=4534999682390530&type=comment#_rnd1597992691705"
        dddsx_url = "https://weibo.com/aj/v6/comment/big?ajwvr=6&more_comment=big&root_comment_id=4534999682390530&is_child_comment=ture&id=4534999572815149&from=singleWeiBo&__rnd=1597993265619"
        dddsx_url = "https://weibo.com/aj/v6/comment/big?ajwvr=6&more_comment=big&child_comment_max_id=238488629463785&child_comment_max_id_type=0&child_comment_ext_param=&child_comment_page=2&is_child_comment=true&root_comment_id=4534999682390530&child_comment_id=&last_child_comment_id=4535003369967338&id=4534999572815149&from=singleWeiBo&__rnd=1597994101012"
        html = self.session.get(dddsx_url)
        html.encoding = 'utf-8'
        print(html.text)
        with open("/home/wxz.html", mode="w") as f:
            f.write(html.text)
...
if __name__ == '__main__':
    username = '463705592@qq.com' # 微博账号
    password = 'wb520520' # 微博密码
